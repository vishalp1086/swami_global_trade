...
const AdminProductForm = () => {
  ...
  const fetchProduct = async () => {
    try {
      const res = await axios.get(`https://swamiglobaltrade-production.up.railway.app/api/products/${id}`);
      const p = res.data;
...
data.append("description", description); // ✅ ADD THIS
      ...
      if (id) {
        await axios.put(`https://swamiglobaltrade-production.up.railway.app/api/products/${id}`, data);
        alert("Updated Successfully");
      } else {
        await axios.post("https://swamiglobaltrade-production.up.railway.app/api/products", data);
